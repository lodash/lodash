  ...
  lodashStable.each(
    ...
    function (methodName, index) {
      ...
      it(
        ...
        function () {
          var object = {
              toString: lodashStable.constant(whitespace + 'a b c' + whitespace)
            },
            expected =
              (index == 2 ? whitespace : '') +
              'a b c' +
      ...
      it(
        '`_.' +
          methodName +
          '` should return an empty string for empty values and `chars`',
        function () {
      ...
      it(
        '`_.' +
          methodName +
          '` should work with `undefined` or empty string values for `chars`',
        function () {
          var string = whitespace + 'a b c' + whitespace,
            expected =
              (index == 2 ? whitespace : '') +
