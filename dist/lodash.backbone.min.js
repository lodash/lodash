...
}}function _(n,r,t){var e=-1,u=n?n.length:0;if(typeof u=="number")for(r=r&&typeof t=="undefined"?r:M(r,t);++e<u&&r(n[e],e,n)!==$;);else hr(n,r,t)}function j(n,r,t){var e=-1,u=n?n.length:0;if(r=M(r,t),typeof u=="number")for(var o=Array(u);++e<u;)o[e]=r(n[e],e,n);else o=[],hr(n,function(n,t,u){o[++e]=r(n,t,u)});return o}function w(n,r,t,e){if(!n)return t;var u=3>arguments.length;r=M(r,e,4);var o=-1,f=n.length;if(typeof f=="number")for(u&&(t=n[++o]);++o<f;)t=r(t,n[o],o,n);else hr(n,function(n,e,o){t=u?(u=!1,n):r(t,n,e,o)
...
(function(){var n={0:1,length:1};cr.argsObject=arguments.constructor==Object,cr.fastBind=tr&&!ar,cr.spliceObjects=(Q.splice.call(n,0,1),!n[0])})(1),o.prototype=r.prototype,T=function(n){var r,t=[];if(!n||!L[typeof n])return t;for(r in n)Y.call(n,r)&&t.push(r);return t},i(arguments)||(i=function(n){return n?Y.call(n,"callee"):!1});var lr=er||function(n){return cr.argsObject&&n instanceof Array||rr.call(n)==P},sr=ur?function(n){return v(n)?ur(n):[]}:T,pr={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};
l(pr);var vr=function(n,r){var t;if(!n||!L[typeof n])return n;r||(r=I);for(t in n)if(r(n[t],t,n)===$)break;return n},hr=function(n,r){var t;if(!n||!L[typeof n])return n;r||(r=I);for(t in n)if(Y.call(n,t)&&r(n[t],t,n)===$)break;return n};p(/x/)&&(p=function(n){return n instanceof Function||"[object Function]"==rr.call(n)}),r.bind=k,r.bindAll=function(n){for(var r=W.apply(Q,arguments),t=1<r.length?0:(r=c(n),-1),e=r.length;++t<e;){var u=r[t];n[u]=k(n[u],n)}return n},r.countBy=function(n,r,t){var e={};
return r=M(r,t),_(n,function(n,t,u){t=r(n,t,u)+"",Y.call(e,t)?e[t]++:e[t]=1}),e},r.defaults=function(n){if(!n)return n;for(var r=1,t=arguments.length;r<t;r++){var e=arguments[r];if(e)for(var u in e)null==n[u]&&(n[u]=e[u])}return n},r.filter=b,r.forEach=_,r.functions=c,r.groupBy=function(n,r,t){var e={};return r=M(r,t),_(n,function(n,t,u){t=r(n,t,u)+"",(Y.call(e,t)?e[t]:e[t]=[]).push(n)}),e},r.initial=function(n,r,t){if(!n)return[];var e=0,u=n.length;if(typeof r!="number"&&null!=r){var o=u;for(r=M(r,t);o--&&r(n[o],o,n);)e++
}else e=null==r||t?1:r||e;return nr.call(n,0,fr(or(0,u-e),u))},r.invert=l,r.invoke=function(n,r){var t=nr.call(arguments,2),e=-1,u=typeof r=="function",o=n?n.length:0,f=Array(typeof o=="number"?o:0);return _(n,function(n){f[++e]=(u?r:n[r]).apply(n,t)}),f},r.keys=sr,r.map=j,r.max=function(n,r,t){var e=-1/0,u=e,o=-1,f=n?n.length:0;if(r||typeof f!="number")r=M(r,t),_(n,function(n,t,o){t=r(n,t,o),t>e&&(e=t,u=n)});else for(;++o<f;)t=n[o],t>u&&(u=t);return u},r.min=function(n,r,t){var e=1/0,u=e,o=-1,f=n?n.length:0;
if(r||typeof f!="number")r=M(r,t),_(n,function(n,t,o){t=r(n,t,o),t<e&&(e=t,u=n)});else for(;++o<f;)t=n[o],t<u&&(u=t);return u},r.omit=function(n){var r=W.apply(Q,arguments),t={};return vr(n,function(n,e){0>E(r,e,1)&&(t[e]=n)}),t},r.once=function(n){var r,t;return function(){return r?t:(r=!0,t=n.apply(this,arguments),n=null,t)}},r.pairs=function(n){for(var r=-1,t=sr(n),e=t.length,u=Array(e);++r<e;){var o=t[r];u[r]=[o,n[o]]}return u},r.pick=function(n){for(var r=0,t=W.apply(Q,arguments),e=t.length,u={};++r<e;){var o=t[r];
o in n&&(u[o]=n[o])}return u},r.reject=function(n,r,t){return r=M(r,t),b(n,function(n,t,e){return!r(n,t,e)})},r.rest=B,r.shuffle=function(n){var r=-1,t=n?n.length:0,e=Array(typeof t=="number"?t:0);return _(n,function(n){var t=X(ir()*(++r+1));e[r]=e[t],e[t]=n}),e},r.sortBy=function(n,r,e){var u=-1,o=n?n.length:0,f=Array(typeof o=="number"?o:0);for(r=M(r,e),_(n,function(n,t,e){f[++u]={a:r(n,t,e),b:u,c:n}}),o=f.length,f.sort(t);o--;)f[o]=f[o].c;return f},r.toArray=function(n){return n&&typeof n.length=="number"?nr.call(n):g(n)
},r.values=g,r.without=function(n){for(var r=-1,t=n.length,e=[];++r<t;){var u=n[r];0>E(arguments,u,1)&&e.push(u)}return e},r.collect=j,r.drop=B,r.each=_,r.extend=a,r.methods=c,r.select=b,r.tail=B,r.clone=function(n){return v(n)?lr(n)?nr.call(n):a({},n):n},r.contains=y,r.escape=function(n){return null==n?"":(n+"").replace(z,u)},r.every=m,r.find=d,r.has=function(n,r){return n?Y.call(n,r):!1},r.identity=I,r.indexOf=E,r.isArguments=i,r.isArray=lr,r.isEmpty=function(n){if(!n)return!0;if(lr(n)||h(n))return!n.length;
for(var r in n)if(Y.call(n,r))return!1;return!0},r.isEqual=s,r.isFunction=p,r.isObject=v,r.isRegExp=function(n){return n instanceof RegExp||rr.call(n)==J},r.isString=h,r.lastIndexOf=function(n,r,t){var e=n?n.length:0;for(typeof t=="number"&&(e=(0>t?or(0,e+t):fr(t,e-1))+1);e--;)if(n[e]===r)return e;return-1},r.mixin=S,r.reduce=w,r.reduceRight=x,r.result=function(n,r){var t=n?n[r]:null;return p(t)?n[r]():t},r.size=function(n){var r=n?n.length:0;return typeof r=="number"?r:sr(n).length},r.some=A,r.sortedIndex=R,r.uniqueId=function(n){var r=++q+"";
return n?n+r:r},r.all=m,r.any=A,r.detect=d,r.foldl=w,r.foldr=x,r.include=y,r.inject=w,r.first=O,r.last=function(n,r,t){if(n){var e=0,u=n.length;if(typeof r!="number"&&null!=r){var o=u;for(r=M(r,t);o--&&r(n[o],o,n);)e++}else if(e=r,null==e||t)return n[u-1];return nr.call(n,or(0,u-e))}},r.take=O,r.head=O,r.chain=function(n){return n=new o(n),n.__chain__=!0,n},r.VERSION="1.0.1",S(r),r.prototype.chain=function(){return this.__chain__=!0,this},r.prototype.value=function(){return this.__wrapped__},_("pop push reverse shift sort splice unshift".split(" "),function(n){var t=Q[n];
r.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),!cr.spliceObjects&&0===n.length&&delete n[0],this}}),_(["concat","join","slice"],function(n){var t=Q[n];r.prototype[n]=function(){var n=t.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new o(n),n.__chain__=!0),n}}),typeof define=="function"&&typeof define.amd=="object"&&define.amd?(n._=r,define(function(){return r})):F&&!F.nodeType?N?(N.exports=r)._=r:F._=r:n._=r})(this);