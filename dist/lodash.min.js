...
},Z.wrap=function(n,t){return vt(t,16,[n])},Z.xor=function(){for(var n=-1,t=arguments.length;++n<t;){var e=arguments[n];if(We(e)||_t(e))var r=r?pt(it(r,e).concat(it(e,r))):e}return r||[]},Z.zip=Mt,Z.zipObject=Vt,Z.collect=Dt,Z.drop=Pt,Z.each=Rt,Z.eachRight=At,Z.extend=H,Z.methods=dt,Z.object=Vt,Z.select=St,Z.tail=Pt,Z.unique=Lt,Z.unzip=Mt,Qt(Z),Z.clone=function(n,t,e,r){return typeof t!="boolean"&&null!=t&&(r=e,e=t,t=false),et(n,t,typeof e=="function"&&ut(e,r,1))},Z.cloneDeep=function(n,t,e){return et(n,true,typeof t=="function"&&ut(t,e,1))
