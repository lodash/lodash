...
-1,b=[],c=E.apply(b,arguments),d=c.length;++a<d;)0>v(b,c[a])&&b.push(c[a]);return b},uniq:ka,uniqueId:function(a){var b=Ea++;return a?a+b:b},values:ta,without:function(a){for(var b=k.call(arguments,1),c=-1,d=a.length,e=[];++c<d;)0>v(b,a[c])&&e.push(a[c]);return e},wrap:function(a,b){return function(){var c=[a];arguments.length&&F.apply(c,arguments);return b.apply(this,c)}},zip:function(){for(var a=-1,b=ia(Q(arguments,"length")),c=Array(b);++a<b;)c[a]=Q(arguments,a);return c},all:W,any:D,collect:Z,
detect:sa,each:G,foldl:$,foldr:ea,head:V,include:C,inject:$,intersect:ha,methods:O,select:ra,tail:ja,take:V,unique:ka});p.prototype=m.prototype;pa(m);G("pop,push,reverse,shift,sort,splice,unshift".split(","),function(a){var b=x[a];p.prototype[a]=function(){var a=this._wrapped;arguments.length?b.apply(a,arguments):b.call(a);a.length===0&&delete a[0];if(this.t){a=new p(a);a.t=n}return a}});G(["concat","join","slice"],function(a){var b=x[a];p.prototype[a]=function(){var a=this._wrapped,a=arguments.length?
b.apply(a,arguments):b.call(a);this.t&&(a=new p(a),a.t=n);return a}});R(p.prototype,{chain:function(){this.t=n;return this},value:function(){return this._wrapped}});X?"object"==typeof module&&module&&module.u==X?(module.u=m)._=m:X._=m:(t._=m,"function"==typeof define&&"object"==typeof define.amd&&define.amd&&define(function(){return m}))})(this);
