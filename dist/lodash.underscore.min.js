...
if(i){for(var t=n,n=e.length,c=-1,l=xt(t.length-n,0),p=-1,s=i.length,g=Array(l+s);++p<s;)g[p]=i[p];for(;++c<n;)g[e[c]]=t[c];for(;l--;)g[p++]=t[c++];n=g}return(this instanceof r?a||R(u):u).apply(f?o:this,n)}var t=n[1];if(t==Sr)return $(n);var e=n[6];if((t==Fr||t==(Sr|Fr))&&!e.length)return U(n);var u=n[0],o=n[3],i=n[4],f=t&Sr,a=!(t&Ir)&&R(u);return r}function m(n,r){var t=n?n.length:0;if(!t)return[];for(var e=-1,u=D(),o=[];++e<t;){var i=n[e];0>u(r,i)&&o.push(i)}return o}function b(n,r){var t=n?n.length:0;
if(typeof t!="number"||-1>=t||t>Br)return x(n,r,Rt);for(var e=-1,u=P(n);++e<t&&r(u[e],e,n)!==Mr;);return n}function _(n,r){var t=n?n.length:0;if(typeof t!="number"||-1>=t||t>Br){for(var t=Rt(n),e=t.length;e--;){var u=t[e];if(r(n[u],u,n)===Mr)break}return n}for(e=P(n);t--&&r(e[t],t,n)!==Mr;);return n}function d(n,r){var t=true;return b(n,function(n,e,u){return(t=!!r(n,e,u))||Mr}),t}function j(n,r){var t=[];return b(n,function(n,e,u){r(n,e,u)&&t.push(n)}),t}function w(n,r,t){var e;return t(n,function(n,t,u){return r(n,t,u)?(e=n,Mr):void 0
...
if("number"!=o&&"string"!=o||!t||t[r]!==n||(r=null),null==r&&$t(n))for(t=-1,o=n.length;++t<o;){var i=n[t];i>u&&(u=i)}else r=h(r,t,3),b(n,function(n,t,o){t=r(n,t,o),(t>e||-1/0===t&&t===u)&&(e=t,u=n)});return u}function er(n,r){return rr(n,Or(r))}function ur(n,r,t,e){return($t(n)?p:M)(n,h(r,e,4),t,3>arguments.length,b)}function or(n,r,t,e){return($t(n)?s:M)(n,h(r,e,4),t,3>arguments.length,_)}function ir(n){n=P(n);for(var r=-1,t=n.length,e=Array(t);++r<t;){var u=F(r);r!=u&&(e[r]=e[u]),e[u]=n[r]}return e
}function fr(n,r,t){return(typeof r!="function"||typeof t!="undefined")&&(r=h(r,t,3)),($t(n)?g:N)(n,r)}function ar(n,r,t){function e(){var t=r-(Ut()-c);0>=t||t>r?(f&&clearTimeout(f),t=s,f=p=s=kr,t&&(g=Ut(),a=n.apply(l,i),p||f||(i=l=null))):p=setTimeout(e,t)}function u(){p&&clearTimeout(p),f=p=s=kr,(v||h!==r)&&(g=Ut(),a=n.apply(l,i),p||f||(i=l=null))}function o(){if(i=arguments,c=Ut(),l=this,s=v&&(p||!y),false===h)var t=y&&!p;else{f||y||(g=c);var o=h-(c-g),m=0>=o||o>h;m?(f&&(f=clearTimeout(f)),g=c,a=n.apply(l,i)):f||(f=setTimeout(u,o))
}return m&&p?p=clearTimeout(p):p||r===h||(p=setTimeout(e,r)),t&&(m=true,a=n.apply(l,i)),!m||p||f||(i=l=null),a}var i,f,a,c,l,p,s,g=0,h=false,v=true;if(!yr(n))throw new TypeError(Nr);if(r=0>r?0:r,true===t)var y=true,v=false;else mr(t)&&(y=t.leading,h="maxWait"in t&&xt(+t.maxWait||0,r),v="trailing"in t?t.trailing:v);return o.cancel=function(){p&&clearTimeout(p),f&&clearTimeout(f),f=p=s=kr},o}function cr(n){if(!yr(n))throw new TypeError(Nr);return function(){return!n.apply(this,arguments)}}function lr(n){return S(n,Fr,J(arguments,1))
...
},o.identity=xr,o.indexOf=G,o.isArguments=hr,o.isArray=$t,o.isBoolean=function(n){return true===n||false===n||n&&typeof n=="object"&&pt.call(n)==Vr||false},o.isDate=function(n){return n&&typeof n=="object"&&pt.call(n)==Gr||false},o.isElement=function(n){return n&&1===n.nodeType||false},o.isEmpty=function(n){if(null==n)return true;var r=n.length;return typeof r=="number"&&-1<r&&r<=Br&&($t(n)||_r(n)||hr(n))?!r:!Rt(n).length},o.isEqual=function(n,r){return E(n,r)},o.isFinite=function(n){return jt(n)&&!wt(parseFloat(n))
},o.isFunction=yr,o.isNaN=function(n){return br(n)&&n!=+n},o.isNull=function(n){return null===n},o.isNumber=br,o.isObject=mr,o.isRegExp=function(n){return mr(n)&&pt.call(n)==Lr||false},o.isString=_r,o.isUndefined=function(n){return typeof n=="undefined"},o.last=function(n,r,t){var e=n?n.length:0;return null==r||t?n?n[e-1]:kr:(r=e-(r||0),J(n,0>r?0:r))},o.lastIndexOf=function(n,r,t){var e=n?n.length:0;for(typeof t=="number"&&(e=(0>t?xt(e+t,0):Tt(t||0,e-1))+1);e--;)if(n[e]===r)return e;return-1},o.max=tr,o.min=function(n,r,t){var e=1/0,u=e,o=typeof r;
if("number"!=o&&"string"!=o||!t||t[r]!==n||(r=null),null==r&&$t(n))for(t=-1,o=n.length;++t<o;){var i=n[t];i<u&&(u=i)}else r=h(r,t,3),b(n,function(n,t,o){t=r(n,t,o),(t<e||1/0===t&&t===u)&&(e=t,u=n)});return u},o.noConflict=function(){return tt._=lt,this},o.now=Ut,o.random=function(n,r){return null==n&&null==r&&(r=1),n=+n||0,null==r?(r=n,n=0):r=+r||0,n+ht(Ot()*(r-n+1))},o.reduce=ur,o.reduceRight=or,o.result=function(n,r){if(null!=n){var t=n[r];return yr(t)?n[r]():t}},o.size=function(n){var r=n?n.length:0;
return typeof r=="number"&&-1<r&&r<=Br?r:Rt(n).length},o.some=fr,o.sortedIndex=K,o.template=function(n,r,t){var u=o,i=u.templateSettings;n=(null==n?"":n)+"",t=sr({},t,i);var f=0,a="__p+='",i=t.variable;if(n.replace(RegExp((t.escape||Dr).source+"|"+(t.interpolate||Dr).source+"|"+(t.evaluate||Dr).source+"|$","g"),function(r,t,u,o,i){return a+=n.slice(f,i).replace(Cr,e),t&&(a+="'+_.escape("+t+")+'"),o&&(a+="';"+o+";\n__p+='"),u&&(a+="'+((__t=("+u+"))==null?'':__t)+'"),f=i+r.length,r}),a+="';",i||(a="with(obj||{}){"+a+"}"),a="function("+(i||"obj")+"){var __t,__p='',__j=Array.prototype.join;function print(){__p+=__j.call(arguments,'')}"+a+"return __p}",t=Ar(function(){return Function("_","return "+a)(u)
}),t.source=a,vr(t))throw t;return r?t(r):t},o.unescape=function(n){return n=null==n?"":n+"",Rr.lastIndex=0,Rr.test(n)?n.replace(Rr,u):n},o.uniqueId=function(n){var r=++$r+"";return n?n+r:r},o.all=X,o.any=fr,o.detect=Z,o.foldl=ur,o.foldr=or,o.head=V,o.include=Q,o.inject=ur,o.sample=function(n,r,t){n=P(n);var e=n.length;return null==r||t?0<e?n[F(e-1)]:kr:(n=ir(n),n.length=Tt(0>r?0:+r||0,n.length),n)},Er(pr({},o)),o.VERSION="3.0.0-pre",o.prototype.chain=function(){return this.__chain__=true,this},o.prototype.value=function(){return this.__wrapped__
},f("pop push reverse shift sort splice unshift".split(" "),function(n){var r=ft[n];o.prototype[n]=function(){var n=this.__wrapped__;return r.apply(n,arguments),kt.spliceObjects||0!==n.length||delete n[0],this}}),f(["concat","join","slice"],function(n){var r=ft[n];o.prototype[n]=function(){var n=r.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new i(n),n.__chain__=true),n}}),typeof define=="function"&&typeof define.amd=="object"&&define.amd?(tt._=o, define("underscore",function(){return o
