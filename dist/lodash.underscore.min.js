...
i in n&&(u[i]=n[i])}return u},f.pluck=M,f.range=function(n,t,r){n=+n||0,r=+r||1,t==nt&&(t=n,n=0);var e=-1;t=qt(0,xt((t-n)/r));for(var u=Array(t);++e<t;)u[e]=n,n+=r;return u},f.reject=function(n,t,r){return t=K(t,r),R(n,function(n,r,e){return!t(n,r,e)})},f.rest=V,f.shuffle=function(n){var t=-1,r=n?n.length:0,e=Array(typeof r=="number"?r:0);return B(n,function(n){var r=Ot($t()*(++t+1));e[t]=e[r],e[r]=n}),e},f.sortBy=function(n,t,r){var e=-1,u=n?n.length:0,o=Array(typeof u=="number"?u:0);for(t=K(t,r),B(n,function(n,r,u){o[++e]={l:t(n,r,u),m:e,n:n}
