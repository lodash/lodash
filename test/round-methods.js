...
describe('round methods', function () {
  lodashStable.each(['ceil', 'floor', 'round'], function (methodName) {
    ...
    it(
      '`_.' +
        methodName +
        '` should return a rounded number without a precision',
      function () {
    ...
    it(
      '`_.' + methodName + '` should work with a precision of `0`',
      function () {
    ...
    it(
      '`_.' + methodName + '` should work with a positive precision',
      function () {
    ...
    it(
      '`_.' + methodName + '` should work with a negative precision',
      function () {
    ...
    it(
      '`_.' + methodName + '` should coerce `precision` to an integer',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should work with exponential notation and `precision`',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should not return `NaN` for large `precision` values',
      function () {
        var results = [round(10.0000001, 1000), round(MAX_SAFE_INTEGER, 293)]
