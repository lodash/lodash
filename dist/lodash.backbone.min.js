...
},u.VERSION="1.0.1",$(u),u.prototype.chain=function(){return this.__chain__=N,this},u.prototype.value=function(){return this.__wrapped__},x("pop push reverse shift sort splice unshift".split(" "),function(n){var t=nt[n];u.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),!gt.spliceObjects&&0===n.length&&delete n[0],this}}),x(["concat","join","slice"],function(n){var t=nt[n];u.prototype[n]=function(){var n=t.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new a(n),n.__chain__=N),n
