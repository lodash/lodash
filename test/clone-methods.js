...
describe('clone methods', function () {
  ...
  lodashStable.each(['clone', 'cloneDeep'], function (methodName) {
    ...
    it(
      '`_.' +
        methodName +
        '` should clone `index` and `input` array properties',
      function () {
    ...
    it(
      '`_.' + methodName + '` should clone `lastIndex` regexp property',
      function () {
        var regexp = /c/g
        regexp.exec('abcde')
    ...
    it(
      '`_.' + methodName + '` should set the `[[Prototype]]` of a clone',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should clone properties that shadow those on `Object.prototype`',
      function () {
        var object = {
    ...
    it(
      '`_.' + methodName + '` should not clone symbol primitives',
      function () {
        if (Symbol) {
          assert.strictEqual(func(symbol), symbol)
        }
    ...
    it(
      '`_.' +
        methodName +
        '` should create an object from the same realm as `value`',
      function () {
        var props = []
  ...
  lodashStable.each(['cloneWith', 'cloneDeepWith'], function (methodName) {
    ...
    it(
      ...
      function () {
        ...
        assert.deepStrictEqual(
          argsList,
          isDeep ? [[object], [1, 'a', object]] : [[object]]
        )
      }
    )
    ...
    it(
      '`_.' +
        methodName +
        '` should handle cloning when `customizer` returns `undefined`',
      function () {
    ...
    lodashStable.forOwn(uncloneable, function (value, key) {
      it(
        '`_.' +
          methodName +
          '` should work with a `customizer` callback and ' +
          key,
        function () {
