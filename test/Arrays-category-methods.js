...
describe('"Arrays" category methods', function () {
  ...
  it('should work with `arguments` objects', function () {
    ...
    assert.deepStrictEqual(
      sortedIndex(sortedArgs, 6),
      3,
      message('sortedIndex')
    )
    assert.deepStrictEqual(
      sortedIndexOf(sortedArgs, 5),
      2,
      message('sortedIndexOf')
    )
    assert.deepStrictEqual(
      sortedLastIndex(sortedArgs, 5),
      3,
      message('sortedLastIndex')
    )
    assert.deepStrictEqual(
      sortedLastIndexOf(sortedArgs, 1),
      0,
  ...
  it('should accept falsey secondary arguments', function () {
    ...
    assert.deepStrictEqual(
      difference(array, null),
      array,
      message('difference')
    )
    assert.deepStrictEqual(
      intersection(array, null),
      [],
      message('intersection')
    )
