...
}return Jr(r,function(r,u,i){return xr.call(i,u)?(c++,!(f=xr.call(n,u)&&l(n[u],r,t,e))&&nr):void 0}),f&&Jr(n,function(n,r,t){return xr.call(t,r)?!(f=-1<--c)&&nr:void 0}),f}function c(n,r,t){for(var e=-1,u=g(),i=n?n.length:0,o=[],a=t?[]:o;++e<i;){var f=n[e],l=t?t(f,e,n):f;(r?!e||a[a.length-1]!==l:0>u(a,l))&&(t&&a.push(l),o.push(f))}return o}function p(n){return function(r,t,e){var u={};return t=K(t,e,3),R(r,function(r,e,i){e=t(r,e,i)+"",n(u,r,e,i)}),u}}function s(n,r,t,e,u,i){var o=1&r,a=2&r,f=4&r,l=16&r;
if(!a&&!x(n))throw new TypeError;if(!o||a||f||l||!(Wr.fastBind||Or&&t.length))c=function(){var l=arguments,h=o?u:this;return t&&Tr.apply(l,t),e&&Er.apply(l,e),f&&l.length<i?(bindData[2]=l,bindData[3]=null,s(c,-25&r)):(a&&(n=h[p]),this instanceof c?(h=v(n.prototype),l=n.apply(h,l),E(l)?l:h):n.apply(h,l))};else{l=[n,u],Er.apply(l,t);var c=Or.call.apply(Or,l)}if(a){var p=u;u=n}return c}function v(n){return E(n)?Sr(n):{}}function h(n){return Ur[n]}function g(){var n=(n=i.indexOf)===U?r:n;return n}function y(n){return Vr[n]
...
}),u}function D(n,r,t){var e=!0;r=K(r,t,3),t=-1;var u=n?n.length:0;if(typeof u=="number")for(;++t<u&&(e=!!r(n[t],t,n)););else Kr(n,function(n,t,u){return!(e=!!r(n,t,u))&&nr});return e}function F(n,r,t){var e=[];r=K(r,t,3),t=-1;var u=n?n.length:0;if(typeof u=="number")for(;++t<u;){var i=n[t];r(i,t,n)&&e.push(i)}else Kr(n,function(n,t,u){r(n,t,u)&&e.push(n)});return e}function N(n,r,t){r=K(r,t,3),t=-1;var e=n?n.length:0;if(typeof e!="number"){var u;return Kr(n,function(n,t,e){return r(n,t,e)?(u=n,nr):void 0
}),u}for(;++t<e;){var i=n[t];if(r(i,t,n))return i}}function R(n,r,t){var e=-1,u=n?n.length:0;if(r=r&&typeof t=="undefined"?r:a(r,t,3),typeof u=="number")for(;++e<u&&r(n[e],e,n)!==nr;);else Kr(n,r)}function B(n,r){var t=n?n.length:0;if(typeof t!="number")var e=Pr(n),t=e.length;R(n,function(u,i,o){return i=e?e[--t]:--t,false===r(n[i],i,o)&&nr})}function k(n,r,t){var e=-1,u=n?n.length:0;if(r=K(r,t,3),typeof u=="number")for(var i=Array(u);++e<u;)i[e]=r(n[e],e,n);else i=[],Kr(n,function(n,t,u){i[++e]=r(n,t,u)
});return i}function q(n,r,t){var e=-1/0,u=e,i=-1,o=n?n.length:0;if(r||typeof o!="number")r=K(r,t,3),R(n,function(n,t,i){t=r(n,t,i),t>e&&(e=t,u=n)});else for(;++i<o;)t=n[i],t>u&&(u=t);return u}function M(n,r){var t=-1,e=n?n.length:0;if(typeof e=="number")for(var u=Array(e);++t<e;)u[t]=n[t][r];return u||k(n,r)}function $(n,r,t,e){if(!n)return t;var u=3>arguments.length;r=a(r,e,4);var i=-1,o=n.length;if(typeof o=="number")for(u&&(t=n[++i]);++i<o;)t=r(t,n[i],i,n);else Kr(n,function(n,e,i){t=u?(u=!1,n):r(t,n,e,i)
...
if(typeof r!="number"&&null!=r){var i=u;for(r=K(r,t,3);i--&&r(n[i],i,n);)e++}else if(e=r,null==e||t)return n[u-1];return Mr.call(n,Br(0,u-e))}},i.take=P,i.head=P,X(i),i.VERSION="1.3.1",i.prototype.chain=function(){return this.__chain__=!0,this},i.prototype.value=function(){return this.__wrapped__},R("pop push reverse shift sort splice unshift".split(" "),function(n){var r=mr[n];i.prototype[n]=function(){var n=this.__wrapped__;return r.apply(n,arguments),!Wr.spliceObjects&&0===n.length&&delete n[0],this
}}),R(["concat","join","slice"],function(n){var r=mr[n];i.prototype[n]=function(){var n=r.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new o(n),n.__chain__=!0),n}}),typeof define=="function"&&typeof define.amd=="object"&&define.amd?(n._=i, define(function(){return i})):hr&&!hr.nodeType?gr?(gr.exports=i)._=i:hr._=i:n._=i}(this);