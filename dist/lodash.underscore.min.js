...
if(!H(n))throw new TypeError;return function(){return r?t:(r=true,t=n.apply(this,arguments),n=null,t)}},o.pairs=function(n){for(var r=-1,t=at(n),e=t.length,u=Array(e);++r<e;){var o=t[r];u[r]=[o,n[o]]}return u},o.partial=function(n){if(n)var r=n[lr]?n[lr][2]:n.length,t=A(arguments,1),r=r-t.length;return b(n,fr,r,null,t)},o.pick=function(n,r){var t=arguments,e=typeof r;"number"!=e&&"string"!=e||!t[2]||t[2][r]!==n||(t=A(t),Vr.call(t,1,2));for(var e=-1,t=v(t,true,false,1),u=t.length,o={};++e<u;){var i=t[e];
