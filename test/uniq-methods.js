...
describe('uniq methods', function () {
  lodashStable.each(
    ...
    function (methodName) {
      ...
      it(
        '`_.' + methodName + '` should treat object instances as unique',
        function () {
      ...
      it(
        '`_.' +
          methodName +
          '` should work with large arrays of boolean, `NaN`, and nullish values',
        function () {
          var largeArray = [],
      ...
      it(
        '`_.' + methodName + '` should work with large arrays of symbols',
        function () {
          if (Symbol) {
      ...
      it(
        '`_.' +
          methodName +
          '` should work with large arrays of well-known symbols',
        function () {
