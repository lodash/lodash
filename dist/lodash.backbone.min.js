...
if(typeof r!="number"&&null!=r){var o=u;for(r=M(r,t);o--&&r(n[o],o,n);)e++}else if(e=r,null==e||t)return n[u-1];return nr.call(n,or(0,u-e))}},r.take=O,r.head=O,r.chain=function(n){return n=new o(n),n.__chain__=!0,n},r.VERSION="1.1.1",S(r),r.prototype.chain=function(){return this.__chain__=!0,this},r.prototype.value=function(){return this.__wrapped__},_("pop push reverse shift sort splice unshift".split(" "),function(n){var t=Q[n];r.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),!cr.spliceObjects&&0===n.length&&delete n[0],this
