(function () {
  ...
  (function () {
    ...
    QUnit.test(
      "should return `false` for non-iteratee calls",
      function (assert) {
        assert.expect(4);
        ...
        if (func) {
          ...
          assert.strictEqual(
            func(1, 0, { length: MAX_SAFE_INTEGER + 1 }),
            false
          );
  ...
  (function () {
    ...
    lodashStable.forOwn(createCaches(pairs), function (cache, kind) {
      ...
      QUnit.test(
        "should implement a `Map` interface for " + kind,
        function (assert) {
          assert.expect(83);
    ...
    lodashStable.forOwn(createCaches(), function (cache, kind) {
      QUnit.test(
        "should support changing values of " + kind,
        function (assert) {
          assert.expect(10);
  ...
  (function () {
    ...
    QUnit.test(
      "should use `func.length` if `n` is not given",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should create a function with a `length` of `0`",
      function (assert) {
        assert.expect(2);
    ...
    QUnit.test(
      "should ensure `new bound` is an instance of `func`",
      function (assert) {
        assert.expect(2);
    ...
    QUnit.test(
      "should not error when instantiating bound built-ins",
      function (assert) {
        assert.expect(2);
  ...
  (function () {
    QUnit.test(
      "should work when the target function is overwritten",
      function (assert) {
        assert.expect(2);
  ...
  lodashStable.each(
    ...
    function (caseName) {
      ...
      QUnit.test(
        "`_." + methodName + "` should deburr letters",
        function (assert) {
          assert.expect(1);

          var actual = lodashStable.map(
            burredLetters,
            function (burred, index) {
              var letter = deburredLetters[index].replace(/['\u2019]/g, "");
              if (caseName == "start") {
                letter =
                  letter == "IJ" ? letter : lodashStable.capitalize(letter);
  ...
  (function () {
    ...
    QUnit.test(
      "should coerce `min` and `max` of `NaN` to `0`",
      function (assert) {
        assert.expect(2);
  ...
  (function () {
    ...
    lodashStable.each(["clone", "cloneDeep"], function (methodName) {
      ...
      lodashStable.forOwn(objects, function (object, kind) {
        QUnit.test(
          "`_." + methodName + "` should clone " + kind,
          function (assert) {
            assert.expect(2);
      ...
      QUnit.test(
        "`_." + methodName + "` should clone array buffers",
        function (assert) {
          assert.expect(2);
      ...
      QUnit.test(
        "`_." + methodName + "` should clone buffers",
        function (assert) {
          assert.expect(4);
      ...
      lodashStable.forOwn(uncloneable, function (value, key) {
        QUnit.test(
          "`_." + methodName + "` should not clone " + key,
          function (assert) {
            assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test(
      "should return `undefined` when no condition is met",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test("should support placeholders", function (assert) {
      ...
      assert.deepEqual(
        curried(ph, ph, ph, 4)(ph, ph, 3)(ph, 2)(1),
        [1, 2, 3, 4]
      );
    });
  ...
  lodashStable.each(
    ...
    function (methodName) {
      ...
      QUnit.test(
        "`_." +
          methodName +
          "` should return the difference of multiple arrays",
        function (assert) {
          assert.expect(1);
  ...
  (function () {
    ...
    lodashStable.each(["`", "/"], function (chr) {
      QUnit.test(
        'should not escape the "' + chr + '" character',
        function (assert) {
          assert.expect(1);
  ...
  lodashStable.each(["flow", "flowRight"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should return a new function",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should return an empty when querying empty arrays",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should swap `start` and `end` when `start` > `end`",
      function (assert) {
        assert.expect(2);
  ...
  (function () {
    ...
    QUnit.test(
      "should work with a function from another realm",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "`_.countBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.differenceBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.dropWhile` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.every` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.filter` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.find` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.findIndex` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.findLast` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.groupBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.maxBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.meanBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.minBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.pullAllBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.reduce` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.reduceRight` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.reject` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.remove` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.some` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.sortBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.sumBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.takeWhile` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.uniqBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.unionBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "`_.xorBy` should use `_.iteratee` internally",
      function (assert) {
        assert.expect(1);
  ...
  lodashStable.each(
    ...
    function (methodName) {
      ...
      QUnit.test(
        "`_." + methodName + "` should match `-0` as `0`",
        function (assert) {
          assert.expect(2);
  ...
  (function () {
    ...
    QUnit.test(
      "should map values in `collection` to a new array",
      function (assert) {
        assert.expect(2);
    ...
    QUnit.test(
      "should treat a nodelist as an array-like object",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should map keys in `object` to a new object",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should map values in `object` to a new object",
      function (assert) {
        assert.expect(1);
  ...
  lodashStable.each(["matches", "isMatch"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should partial match arrays",
      function (assert) {
        assert.expect(3);
    ...
    QUnit.test(
      "`_." + methodName + "` should partial match maps",
      function (assert) {
        assert.expect(3);
    ...
    QUnit.test(
      "`_." + methodName + "` should partial match sets",
      function (assert) {
        assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test(
      "should not match by inherited `srcValue` properties",
      function (assert) {
        assert.expect(2);
    ...
    QUnit.test(
      "should match `undefined` values of nested objects",
      function (assert) {
        assert.expect(4);
    ...
    QUnit.test(
      "should match `undefined` values on primitives",
      function (assert) {
        assert.expect(2);
  ...
  (function () {
    QUnit.test(
      "should return the largest value from a collection",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should not assign inherited `source` methods",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        var testObj1 = {};
        assert.strictEqual(
          typeof testObj1.toString,
          "function",
          "Object.toString should work before omit"
        );
        ...
        var testObj2 = {};
        assert.strictEqual(
          typeof testObj2.toString,
          "function",
          "Object.toString should still work after omit"
        );
        assert.strictEqual(
          Object.prototype.toString.call({}),
          "[object Object]",
          "Object.toString should behave as expected"
        );
      }
    );
  })();
  ...
  (function () {
    QUnit.test(
      "should create a function that invokes `iteratees`",
      function (assert) {
        assert.expect(1);
  ...
  lodashStable.each(["partial", "partialRight"], function (methodName) {
    ...
    QUnit.test(
      "should work with placeholders and curried functions",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    QUnit.test("should work as a deep `_.defaults`", function (assert) {
      ...
      var defaultsDeep = _.partialRight(
        _.mergeWith,
  ...
  (function () {
    QUnit.test(
      "should modify the array and return removed elements",
      function (assert) {
        assert.expect(2);
  ...
  (function () {
    ...
    QUnit.test(
      "should work with fewer indexes than arguments",
      function (assert) {
        assert.expect(1);
    ...
    QUnit.test(
      "should work on functions that have been rearged",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should return all elements when `n` >= `length`",
      function (assert) {
        assert.expect(4);
  ...
  lodashStable.each(["orderBy", "sortBy"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should support iteratees",
      function (assert) {
        assert.expect(1);
  ...
  lodashStable.each(["sortedIndex", "sortedLastIndex"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should align with `_.sortBy`",
      function (assert) {
        assert.expect(12);
  ...
  lodashStable.each(
    ...
    function (methodName) {
      ...
      QUnit.test(
        "`_." + methodName + "` should return " + pair[1],
        function (assert) {
          assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should return an empty array when `n` < `1`",
      function (assert) {
        assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test(
      "should work with statements containing quotes",
      function (assert) {
        assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        assert.strictEqual(
          _.truncate(string, { length: string.length }),
          string
        );
        assert.strictEqual(
  ...
  lodashStable.each(["slice", "toArray"], function (methodName) {
    ...
    QUnit.test(
      "`_." + methodName + "` should return a dense array",
      function (assert) {
        assert.expect(3);
    ...
    function (methodName) {
      ...
      QUnit.test(
        ...
        function (assert) {
          ...
          assert.deepEqual(
            _[methodName](largeStr),
            methodName == "toNumber" ? NaN : 0
          );
  ...
  (function () {
    ...
    QUnit.test(
      "should convert `arguments` objects to plain objects",
      function (assert) {
        assert.expect(1);
    ...
    function (methodName, index) {
      ...
      QUnit.test(
        ...
        function (assert) {
          ...
          var object = {
              toString: lodashStable.constant(
                whitespace + "a b c" + whitespace
              ),
            },
            expected =
              (index == 2 ? whitespace : "") +
  ...
  (function () {
    ...
    lodashStable.each(["&#96;", "&#x2F;"], function (entity) {
      QUnit.test(
        'should not unescape the "' + entity + '" entity',
        function (assert) {
          assert.expect(1);
  ...
  (function () {
    ...
    QUnit.test(
      "should follow `path` over non-plain objects",
      function (assert) {
        assert.expect(8);
    ...
    QUnit.test(
      ...
      function (assert) {
        ...
        var testStr1 = "ABC";
        assert.strictEqual(
          typeof testStr1.toLowerCase,
          "function",
          "String.toLowerCase should exist before unset"
        );
        ...
        var testStr2 = "ABC";
        assert.strictEqual(
          typeof testStr2.toLowerCase,
          "function",
          "String.toLowerCase should still exist after unset"
        );
        assert.strictEqual(
          testStr2.toLowerCase(),
          "abc",
          "String.toLowerCase should work as expected"
        );
      }
    );
  })();
  ...
  ["__proto__", "constructor", "prototype"].forEach(function (keyToTest) {
    ...
    QUnit.test(
      "zipObjectDeep is not overwriting global." + keyToTest,
      function (assert) {
        assert.expect(2);
  ...
  lodashStable.each(["unzip", "zip"], function (methodName, index) {
    ...
    lodashStable.forOwn(object, function (pair, key) {
      QUnit.test(
        "`_." + methodName + "` should work with " + key,
        function (assert) {
          assert.expect(2);
  ...
  lodashStable.each([false, true], function (implicit) {
    ...
    QUnit.test(
      "should follow the iterator protocol " + chainType,
      function (assert) {
        assert.expect(3);
    ...
    QUnit.test(
      "should reset the iterator correctly " + chainType,
      function (assert) {
        assert.expect(4);
    ...
    QUnit.test(
      "should work in a lazy sequence " + chainType,
      function (assert) {
        assert.expect(3);
  ...
  (function () {
    ...
    QUnit.test(
      "should reset iterator data on cloned sequences",
      function (assert) {
        assert.expect(3);
