  ...
  lodashStable.each(
    ...
    function (methodName) {
      ...
      it(
        '`_.' +
          methodName +
          '` should convert number primitives and objects to numbers',
        function () {
      ...
      it(
        '`_.' +
          methodName +
          '` should convert string primitives and objects to numbers',
        function () {
      ...
      it(
        '`_.' +
          methodName +
          '` should convert invalid binary/octal strings to `' +
          (isToNumber ? 'NaN' : '0') +
          '`',
        function () {
          var transforms = [identity, pad, positive, negative],
