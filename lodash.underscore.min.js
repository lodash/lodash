...
return t=i(t,r),k(n,function(n,r,u){r=t(n,r,u)+"",(at.call(e,r)?e[r]:e[r]=[]).push(n)}),e},u.initial=function(n,t,r){if(!n)return[];var e=0,u=n.length;if(typeof t=="function"){var o=u;for(t=i(t,r);o--&&t(n[o],o,n);)e++}else e=t==H||r?1:t||e;return l(n,0,yt(ht(0,u-e),u))},u.intersection=function(n){var t=arguments,r=t.length,e=-1,u=n?n.length:0,o=[];n:for(;++e<u;){var i=n[e];if(0>$(o,i)){for(var a=r;--a;)if(0>$(t[a],i))continue n;o.push(i)}}return o},u.invert=_,u.invoke=function(n,t){var r=l(arguments,2),e=-1,u=typeof t=="function",o=n?n.length:0,i=Array(typeof o=="number"?o:0);
...
}return u},u.omit=function(n){var t=ot.apply(Q,arguments),e={};return r(n,function(n,r){0>$(t,r,1)&&(e[r]=n)}),e},u.once=function(n){var t,r;return function(){return t?r:(t=G,r=n.apply(this,arguments),n=H,r)}},u.pairs=function(n){for(var t=-1,r=Tt(n),e=r.length,u=Array(e);++t<e;){var o=r[t];u[t]=[o,n[o]]}return u},u.pick=function(n){for(var t=0,r=ot.apply(Q,arguments),e=r.length,u={};++t<e;){var o=r[t];o in n&&(u[o]=n[o])}return u},u.pluck=R,u.range=function(n,t,r){n=+n||0,r=+r||1,t==H&&(t=n,n=0);
var e=-1;t=ht(0,ut((t-n)/r));for(var u=Array(t);++e<t;)u[e]=n,n+=r;return u},u.reject=function(n,t,r){return t=i(t,r),O(n,function(n,r,e){return!t(n,r,e)})},u.rest=I,u.shuffle=function(n){var t=-1,r=n?n.length:0,e=Array(typeof r=="number"?r:0);return k(n,function(n){var r=it(_t()*(++t+1));e[t]=e[r],e[r]=n}),e},u.sortBy=function(n,t,r){var e=-1,u=n?n.length:0,a=Array(typeof u=="number"?u:0);for(t=i(t,r),k(n,function(n,r,u){a[++e]={a:t(n,r,u),b:e,c:n}}),u=a.length,a.sort(o);u--;)a[u]=a[u].c;return a
},u.tap=function(n,t){return t(n),n},u.throttle=function(n,t){function r(){a=new Date,i=H,u=n.apply(o,e)}var e,u,o,i,a=0;return function(){var f=new Date,c=t-(f-a);return e=arguments,o=this,0<c?i||(i=setTimeout(r,c)):(clearTimeout(i),i=H,a=f,u=n.apply(o,e)),u}},u.times=function(n,t,r){n=+n||0;for(var e=-1,u=Array(n);++e<n;)u[e]=t.call(r,e);return u},u.toArray=function(n){return n&&typeof n.length=="number"?l(n):x(n)},u.union=function(){return C(ot.apply(Q,arguments))},u.uniq=C,u.values=x,u.where=function(n,t){return O(n,t)
},u.without=function(n){for(var t=-1,r=n.length,e=[];++t<r;){var u=n[t];0>$(arguments,u,1)&&e.push(u)}return e},u.wrap=function(n,t){return function(){var r=[n];return ft.apply(r,arguments),t.apply(this,r)}},u.zip=function(n){for(var t=-1,r=n?F(R(arguments,"length")):0,e=Array(r);++t<r;)e[t]=R(arguments,t);return e},u.collect=N,u.drop=I,u.each=k,u.extend=g,u.methods=y,u.select=O,u.tail=I,u.unique=C,u.clone=function(n){return b(n)?Rt(n)?l(n):g({},n):n},u.contains=A,u.escape=function(n){return n==H?"":(n+"").replace(rt,f)
},u.every=E,u.find=S,u.has=function(n,t){return n?at.call(n,t):J},u.identity=U,u.indexOf=$,u.isArguments=s,u.isArray=Rt,u.isBoolean=function(n){return n===G||n===J||ct.call(n)==bt},u.isDate=function(n){return n instanceof Date||ct.call(n)==jt},u.isElement=function(n){return n?1===n.nodeType:J},u.isEmpty=function(n){if(!n)return G;if(Rt(n)||w(n))return!n.length;for(var t in n)if(at.call(n,t))return J;return G},u.isEqual=m,u.isFinite=function(n){return st(n)&&!vt(parseFloat(n))},u.isFunction=d,u.isNaN=function(n){return j(n)&&n!=+n
},u.isNull=function(n){return n===H},u.isNumber=j,u.isObject=b,u.isRegExp=function(n){return n instanceof RegExp||ct.call(n)==At},u.isString=w,u.isUndefined=function(n){return typeof n=="undefined"},u.lastIndexOf=function(n,t,r){var e=n?n.length:0;for(typeof r=="number"&&(e=(0>r?ht(0,e+r):yt(r,e-1))+1);e--;)if(n[e]===t)return e;return-1},u.mixin=V,u.noConflict=function(){return n._=Y,this},u.random=function(n,t){return n==H&&t==H&&(t=1),n=+n||0,t==H&&(t=n,n=0),n+it(_t()*((+t||0)-n+1))},u.reduce=T,u.reduceRight=q,u.result=function(n,t){var r=n?n[t]:H;
...
if(typeof t=="function"){var o=u;for(t=i(t,r);o--&&t(n[o],o,n);)e++}else if(e=t,e==H||r)return n[u-1];return l(n,ht(0,u-e))}},u.take=D,u.head=D,u.chain=function(n){return n=new u(n),n.__chain__=G,n},u.VERSION="1.0.0-rc.3",V(u),u.prototype.chain=function(){return this.__chain__=G,this},u.prototype.value=function(){return this.__wrapped__},e("pop push reverse shift sort splice unshift".split(" "),function(n){var t=Q[n];u.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),St&&0===n.length&&delete n[0],this
