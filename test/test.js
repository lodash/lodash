;(function() {
  ...
  (function() {
    test('should unset property on given `object`', 4, function() {
      ...
      strictEqual(_.unset(object, 'a'), true);
    ...
    test('should unset deep property on given `object`', 4, function() {
      ...
      strictEqual(_.unset(object, ['a', 'b', 'c']), true);
    ...
    test('should return undefined if `path` dosen\'t exists on given `object`', 5, function() {
      var object = { 'a': { 'b': { 'c': null } } };
      strictEqual(_.unset(object, 'z'), undefined);
      strictEqual(_.unset(object, 'a.z'), undefined);
      strictEqual(_.unset(object, 'a.b.z'), undefined);
      strictEqual(_.unset(object, 'a.b.c.z'), undefined);
    ...
    test('should return false for not configurable properties', 1, function() {
      var object = {};
