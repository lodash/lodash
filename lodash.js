...
;(function() {
  ...
  function runInContext(context) {
     ...
     * `invert`, `invoke`, `keys`, `map`, `mapKeys`, `mapValues`, `matches`, `max`,
     * `memoize`, `merge`, `min`, `noop`, `object`, `omit`, `once`, `pairs`, `partial`,
     ...
     * @category Objects
     * @param {Object} object The object to iterate over.
     * @param {Function|string} [callback=key] The function called per
     *  iteration. If a property name is provided it will be used to create a
     *  "_.pluck" style callback
     * @param {*} [thisArg] The `this` binding of `callback`.
     * @returns {Object} Returns the new mapped object.
     * @example
     *
     * _.mapKeys({ 'a': 1, 'b': 2, 'c': 3} , function(num, letter) { return letter + letter; });
     * // => { 'aa': 1, 'bb': 2, 'cc': 3 }
     */
