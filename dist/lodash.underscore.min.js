...
}var u,o,i,a;return function(){var f=t&&!a;return u=arguments,i=this,_r(a),a=wr(e,r),f&&(o=n.apply(i,u)),o}},e.defaults=g,e.defer=function(n){var r=l(arguments,1);return wr(function(){n.apply(void 0,r)},1)},e.delay=function(n,r){var t=l(arguments,2);return wr(function(){n.apply(void 0,t)},r)},e.difference=function(n){for(var r=-1,t=n.length,e=mr.apply(vr,arguments),u=[];++r<t;){var o=n[r];0>z(e,o,t)&&u.push(o)}return u},e.filter=S,e.flatten=I,e.forEach=k,e.functions=y,e.groupBy=function(n,r,t){var e={};
...
}}),K?L?(L.exports=e)._=e:K._=e:n._=e})(this);