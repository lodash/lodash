;(function() {
  ...
  /*--------------------------------------------------------------------------*/
  QUnit.module('lodash.invokeSafe');
  ...
  (function() {
    ...
    QUnit.test('should support invoking with arguments', function(assert) {
      ...
      var object = { 'a': function(a, b) { return [a, b]; } },
          actual = _.invokeSafe(object, 'a', 1, 2);
    ...
    QUnit.test('should not error on nullish elements', function(assert) {
      ...
      var actual = lodashStable.map(values, function(value) {
        try {
          return _.invokeSafe(value, 'a.b', 1, 2);
        } catch (e) {}
      });
    ...
    QUnit.test('should not error on not a function and return undefined', function(assert) {
      assert.expect(1);
    ...
    QUnit.test('should preserve the sign of `0`', function(assert) {
      ...
      var actual = lodashStable.map(props, function(key) {
        return _.invokeSafe(object, key);
      });
    ...
    QUnit.test('should support deep paths', function(assert) {
      ...
      lodashStable.each(['a.b', ['a', 'b']], function(path) {
        var actual = _.invokeSafe(object, path, 1, 2);
        assert.deepEqual(actual, [1, 2]);
      });
    });
    ...
    QUnit.test('should invoke deep property methods with the correct `this` binding', function(assert) {
      ...
      lodashStable.each(['a.b', ['a', 'b']], function(path) {
        assert.deepEqual(_.invokeSafe(object, path), 1);
      });
    });
    ...
    QUnit.test('should return an unwrapped value when implicitly chaining', function(assert) {
      ...
      if (!isNpm) {
        var object = { 'a': stubOne };
        assert.strictEqual(_(object).invokeSafe('a'), 1);
      }
      else {
        skipAssert(assert);
      }
    ...
    QUnit.test('should return a wrapped value when explicitly chaining', function(assert) {
      ...
      if (!isNpm) {
        var object = { 'a': stubOne };
        assert.ok(_(object).chain().invokeSafe('a') instanceof _);
      }
      else {
        skipAssert(assert);
      }
