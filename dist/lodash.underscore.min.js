...
var o=-1,i=n?n.length:0;if(null==r&&typeof i=="number"&&-1<i&&i<=Pr)for(;++o<i;)t=n[o],t<u&&(u=t);else r=or(r,t,3),g(n,function(n,t,o){t=r(n,t,o),t<e&&(e=t,u=n)});return u},o.omit=function(n){for(var r=y(arguments,true,false,1),t=r.length;t--;)r[t]=r[t]+"";return er(n,s(tr(n),r))},o.once=function(n){var r,t;if(!Y(n))throw new TypeError(vr);return function(){return r?t:(r=true,t=n.apply(this,arguments),n=null,t)}},o.pairs=function(n){for(var r=-1,t=vt(n),e=t.length,u=Array(e);++r<e;){var o=t[r];u[r]=[o,n[o]]
