...
/**
 * The base implementation of `mean` and `meanBy`.
 *
 * @private
 * @param array The array to iterate over.
 * @param iteratee The function invoked per iteration.
 ...
 * @category Math
 * @param array The array to iterate over.
 * @param iteratee The property name to average by.
 * @returns Returns the mean.
 * @see mean, sum, sumBy
 * @example
 *
 ...
 * // => 5
 */
function meanBy<T extends object>(
  array: ArrayLike<T>,
...
function meanBy<T>(
  ...
  return baseMean(array, iterateeFunc)
}
