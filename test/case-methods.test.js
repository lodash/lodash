...
describe('case methods', function () {
  lodashStable.each(
    ['camel', 'kebab', 'lower', 'snake', 'start', 'upper'],
    function (caseName) {
      ...
      it(
        '`_.' +
          methodName +
          '` should convert `string` to ' +
          caseName +
          ' case',
        function () {
          var actual = lodashStable.map(strings, function (string) {
            var expected =
              caseName == 'start' && string == 'FOO BAR' ? string : converted
      ...
      it(
        '`_.' + methodName + '` should handle double-converting strings',
        function () {
          var actual = lodashStable.map(strings, function (string) {
            var expected =
              caseName == 'start' && string == 'FOO BAR' ? string : converted
      ...
      it(
        '`_.' + methodName + '` should remove contraction apostrophes',
        function () {
      ...
      it(
        '`_.' + methodName + '` should remove Latin mathematical operators',
        function () {
      ...
      it(
        ...
        function () {
          ...
          assert.strictEqual(
            func({ toString: lodashStable.constant(string) }),
            converted
          )
        }
      )
  ...
  ;(function () {
    it('should get the original value after cycling through all case methods', function () {
      ...
      var actual = lodashStable.reduce(
        funcs,
