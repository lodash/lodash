 ...
 * not given, the first element of `collection` is used as the initial value.
 * The iteratee is invoked with four arguments: (accumulator, value, index|key,
 * collection).
 *
