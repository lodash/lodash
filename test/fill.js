...
describe('fill', function() {
  ...
  it('should treat falsey `start` values as `0`', function() {
    let expected = lodashStable.map(falsey, lodashStable.constant(['a', 'a', 'a']));

    let actual = lodashStable.map(falsey, function(start) {
      let array = [1, 2, 3];
  ...
  it('should treat falsey `end` values, except `undefined`, as `0`', function() {
    ...
    let actual = lodashStable.map(falsey, function(end) {
      let array = [1, 2, 3];
  ...
  it('should coerce `start` and `end` to integers', function() {
    ...
    let actual = lodashStable.map(positions, function(pos) {
      let array = [1, 2, 3];
