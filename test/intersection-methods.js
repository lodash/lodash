...
describe('intersection methods', function () {
  lodashStable.each(
    ...
    function (methodName) {
      ...
      it(
        '`_.' + methodName + '` should return the intersection of two arrays',
        function () {
      ...
      it(
        '`_.' +
          methodName +
          '` should return the intersection of multiple arrays',
        function () {
      ...
      it(
        '`_.' + methodName + '` should work with large arrays of `NaN`',
        function () {
      ...
      it(
        '`_.' + methodName + '` should work with large arrays of objects',
        function () {
          var object = {},
            largeArray = lodashStable.times(
              LARGE_ARRAY_SIZE,
              lodashStable.constant(object)
            )

          assert.deepStrictEqual(func([object], largeArray), [object])
          assert.deepStrictEqual(
            func(lodashStable.range(LARGE_ARRAY_SIZE), [1]),
            [1]
          )
        }
      )
