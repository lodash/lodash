...
{return zt||gt&&2<arguments.length?gt.call.apply(gt,arguments):a(e,t,vt.call(arguments,2))}function U(e){return e}function z(e){an(w(e),function(t){var r=s[t]=e[t];s.prototype[t]=function(){var e=[this.__wrapped__];return arguments.length&&pt.apply(e,arguments),e=r.apply(s,e),this.__chain__&&(e=new s(e),e.__chain__=n),e}})}var n=!0,r=null,i=!1,W="object"==typeof exports&&exports&&("object"==typeof global&&global&&global==global.global&&(e=global),exports),X=Array.prototype,V=Object.prototype,$=0,
J=30,K=e._,Q=/[-?+=!~*%&^<>|{(\/]|\[\D|\b(?:delete|in|instanceof|new|typeof|void)\b/,G=/&(?:amp|lt|gt|quot|#x27);/g,Y=/\b__p\+='';/g,Z=/\b(__p\+=)''\+/g,et=/(__e\(.*?\)|\b__t\))\+'';/g,tt=/\w*$/,nt=/(?:__e|__t=)\(\s*(?![\d\s"']|this\.)/g,rt=RegExp("^"+(V.valueOf+"").replace(/[.*+?^=!:${}()|[\]\/\\]/g,"\\$&").replace(/valueOf|for [^\]]+/g,".+?")+"$"),it=/($^)/,st=/[&<>"']/g,ot=/['\n\r\t\u2028\u2029\\]/g,ut="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf"
.split(" "),at=Math.ceil,ft=X.concat,lt=Math.floor,ct=rt.test(ct=Object.getPrototypeOf)&&ct,ht=V.hasOwnProperty,pt=X.push,dt=V.propertyIsEnumerable,vt=X.slice,mt=V.toString,gt=rt.test(gt=vt.bind)&&gt,yt=rt.test(yt=Array.isArray)&&yt,bt=e.isFinite,wt=rt.test(wt=Object.keys)&&wt,Et=Math.max,St=Math.min,xt=Math.random,Tt="[object Arguments]",Nt="[object Array]",Ct="[object Boolean]",kt="[object Date]",Lt="[object Number]",At="[object Object]",Ot="[object RegExp]",Mt="[object String]",_t=e.clearTimeout
,Dt=e.setTimeout,Pt,Ht,Bt,jt=n;(function(){function e(){this.x=1}var t={0:1,length:1},n=[];e.prototype={valueOf:1,y:1};for(var r in new e)n.push(r);for(r in arguments)jt=!r;Pt=4>(n+"").length,Bt="x"!=n[0],Ht=(n.splice.call(t,0,1),t[0])})(1);var Ft=!v(arguments),It="x"!=vt.call("x")[0],qt="xx"!="x"[0]+Object("x")[0];try{var Rt=("[object Object]",mt.call(e.document||0)==At)}catch(Ut){}var zt=gt&&/\n|Opera/.test(gt+mt.call(e.opera)),Wt=wt&&/^.+$|true/.test(wt+!!e.attachEvent),Xt=!zt,Vt={};Vt[Tt]=Vt["[object Function]"
]=i,Vt[Nt]=Vt[Ct]=Vt[kt]=Vt[Lt]=Vt[At]=Vt[Ot]=Vt[Mt]=n;var $t={"boolean":i,"function":n,object:n,number:i,string:i,"undefined":i,unknown:n},Jt={"\\":"\\","'":"'","\n":"n","\r":"r","	":"t","\u2028":"u2028","\u2029":"u2029"};s.templateSettings={escape:/<%-([\s\S]+?)%>/g,evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,variable:""};var Kt={a:"d,c,s",n:"c=e(c,s)",h:"if(c(u,h,d)===false)return p"},Qt={o:i,p:i,a:"l",n:"for(var a=1,b=arguments.length;a<b;a++){if(i=arguments[a]){",j:"p[h]=u",d:"}}"
},Gt={h:r,j:Kt.h},Yt=l(Kt,Gt,{o:i}),Zt=l(Kt,Gt);Ft&&(v=function(e){return e?ht.call(e,"callee"):i});var en=yt||function(e){return mt.call(e)==Nt};m(/x/)&&(m=function(e){return"[object Function]"==mt.call(e)});var tn=ct?function(e){if(!e||"object"!=typeof e)return i;var t=e.valueOf,n="function"==typeof t&&(n=ct(t))&&ct(n);return n?e==n||ct(e)==n&&!v(e):g(e)}:g,nn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;"},rn=E(nn),sn=l(Qt,{j:"if(p[h]==null)"+Qt.j}),on=l(Qt),un=wt?function(e){var t=typeof 
e;return"function"==t&&dt.call(e,"prototype")?y(e):e&&$t[t]?wt(e):[]}:y,an=l(Kt),fn=l({p:i,a:"l",n:"var w=arguments,h=w.length>1?0:(w=x(l),-1),j=w.length;while(++h<j){u=w[h];p[u]=v(p[u],p)}return p"});s.VERSION="0.8.2",s.after=function(e,t){return 1>e?t():function(){if(1>--e)return t.apply(this,arguments)}},s.bind=R,s.bindAll=fn,s.chain=function(e){return e=new s(e),e.__chain__=n,e},s.clone=b,s.compact=function(e){for(var t=-1,n=e?e.length:0,r=[];++t<n;){var i=e[t];i&&r.push(i)}return r},s.compose=
...
.apply(t,n)},1)},s.delay=function(e,n){var r=vt.call(arguments,2);return Dt(function(){return e.apply(t,r)},n)},s.difference=function(e){var t=[];if(!e)return t;for(var n=-1,r=e.length,i=ft.apply(X,arguments),i=o(i,r);++n<r;){var s=e[n];i(s)||t.push(s)}return t},s.escape=function(e){return e==r?"":(e+"").replace(st,h)},s.every=C,s.extend=on,s.filter=k,s.find=L,s.first=H,s.flatten=B,s.forEach=an,s.forIn=Yt,s.forOwn=Zt,s.functions=w,s.groupBy=function(e,t,n){var r={},t=f(t,n);return an(e,function(e
...
.length&&pt.apply(n,arguments),t.apply(this,n)}},s.zip=function(e){for(var t=-1,n=e?O(M(arguments,"length")):0,r=Array(n);++t<n;)r[t]=M(arguments,t);return r},s.all=C,s.any=P,s.collect=A,s.detect=L,s.drop=F,s.each=an,s.foldl=_,s.foldr=D,s.head=H,s.include=N,s.inject=_,s.methods=w,s.select=k,s.tail=F,s.take=H,s.unique=q,z(s),s.prototype.chain=function(){return this.__chain__=n,this},s.prototype.value=function(){return this.__wrapped__},an("pop push reverse shift sort splice unshift".split(" "),function(
e){var t=X[e];s.prototype[e]=function(){var e=this.__wrapped__;return t.apply(e,arguments),Ht&&e.length===0&&delete e[0],this.__chain__&&(e=new s(e),e.__chain__=n),e}}),an(["concat","join","slice"],function(e){var t=X[e];s.prototype[e]=function(){var e=t.apply(this.__wrapped__,arguments);return this.__chain__&&(e=new s(e),e.__chain__=n),e}}),typeof define=="function"&&typeof define.amd=="object"&&define.amd?(e._=s,define(function(){return s})):W?"object"==typeof module&&module&&module.exports==W?
(module.exports=s)._=s:W._=s:e._=s})(this);