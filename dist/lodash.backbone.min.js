...
}return vr(t,function(r,t,o){return Z.call(o,t)?(c++,!(a=Z.call(n,t)&&p(n[t],r,e,u))&&D):void 0}),a&&vr(n,function(n,r,t){return Z.call(t,r)?!(a=-1<--c)&&D:void 0}),a}function s(n){return typeof n=="function"}function v(n){return n?Q[typeof n]:!1}function h(n){return typeof n=="string"||rr.call(n)==L}function g(n){for(var r=-1,t=pr(n),e=t.length,u=Array(e);++r<e;)u[r]=n[t[r]];return u}function y(n,r){var t=!1;return typeof(n?n.length:0)=="number"?t=-1<B(n,r):hr(n,function(n){return(t=n===r)&&D}),t}function m(n,r,t){var e=!0;
r=I(r,t),t=-1;var u=n?n.length:0;if(typeof u=="number")for(;++t<u&&(e=!!r(n[t],t,n)););else hr(n,function(n,t,u){return!(e=!!r(n,t,u))&&D});return e}function d(n,r,t){var e=[];r=I(r,t),t=-1;var u=n?n.length:0;if(typeof u=="number")for(;++t<u;){var o=n[t];r(o,t,n)&&e.push(o)}else hr(n,function(n,t,u){r(n,t,u)&&e.push(n)});return e}function b(n,r,t){r=I(r,t),t=-1;var e=n?n.length:0;if(typeof e!="number"){var u;return hr(n,function(n,t,e){return r(n,t,e)?(u=n,D):void 0}),u}for(;++t<e;){var o=n[t];if(r(o,t,n))return o
}}function _(n,r,t){var e=-1,u=n?n.length:0;if(r=r&&typeof t=="undefined"?r:I(r,t),typeof u=="number")for(;++e<u&&r(n[e],e,n)!==D;);else hr(n,r)}function j(n,r,t){var e=-1,u=n?n.length:0;if(r=I(r,t),typeof u=="number")for(var o=Array(u);++e<u;)o[e]=r(n[e],e,n);else o=[],hr(n,function(n,t,u){o[++e]=r(n,t,u)});return o}function w(n,r,t,e){if(!n)return t;var u=3>arguments.length;r=I(r,e,4);var o=-1,f=n.length;if(typeof f=="number")for(u&&(t=n[++o]);++o<f;)t=r(t,n[o],o,n);else hr(n,function(n,e,o){t=u?(u=!1,n):r(t,n,e,o)
...
});else for(;++o<f;)t=n[o],t<u&&(u=t);return u},r.omit=function(n){var r=X.apply(U,ar.call(arguments,1)),t={};return vr(n,function(n,e){0>B(r,e)&&(t[e]=n)}),t},r.once=function(n){var r,t;return function(){return r?t:(r=!0,t=n.apply(this,arguments),n=null,t)}},r.pairs=function(n){for(var r=-1,t=pr(n),e=t.length,u=Array(e);++r<e;){var o=t[r];u[r]=[o,n[o]]}return u},r.pick=function(n){for(var r=-1,t=X.apply(U,ar.call(arguments,1)),e=t.length,u={};++r<e;){var o=t[r];o in n&&(u[o]=n[o])}return u},r.reject=function(n,r,t){return r=I(r,t),d(n,function(n,t,e){return!r(n,t,e)
})},r.rest=k,r.shuffle=function(n){var r=-1,t=n?n.length:0,e=Array(typeof t=="number"?t:0);return _(n,function(n){var t=Y(ir()*(++r+1));e[r]=e[t],e[t]=n}),e},r.sortBy=function(n,r,e){var u=-1,o=n?n.length:0,f=Array(typeof o=="number"?o:0);for(r=I(r,e),_(n,function(n,t,e){f[++u]={a:r(n,t,e),b:u,c:n}}),o=f.length,f.sort(t);o--;)f[o]=f[o].c;return f},r.toArray=function(n){return gr(n)?ar.call(n):n&&typeof n.length=="number"?j(n):g(n)},r.values=g,r.without=function(n){return O(n,ar.call(arguments,1))
},r.collect=j,r.drop=k,r.each=_,r.extend=a,r.methods=c,r.select=d,r.tail=k,r.clone=function(n){return v(n)?gr(n)?ar.call(n):a({},n):n},r.contains=y,r.escape=function(n){return null==n?"":(n+"").replace(z,u)},r.every=m,r.find=b,r.has=function(n,r){return n?Z.call(n,r):!1},r.identity=S,r.indexOf=B,r.isArguments=i,r.isArray=gr,r.isEmpty=function(n){if(!n)return!0;if(gr(n)||h(n))return!n.length;for(var r in n)if(Z.call(n,r))return!1;return!0},r.isEqual=p,r.isFunction=s,r.isObject=v,r.isRegExp=function(n){return rr.call(n)==K
...
if(typeof r!="number"&&null!=r){var o=u;for(r=I(r,t);o--&&r(n[o],o,n);)e++}else if(e=r,null==e||t)return n[u-1];return ar.call(n,or(0,u-e))}},r.take=E,r.head=E,r.chain=function(n){return n=new o(n),n.__chain__=!0,n},r.VERSION="1.1.1",N(r),r.prototype.chain=function(){return this.__chain__=!0,this},r.prototype.value=function(){return this.__wrapped__},_("pop push reverse shift sort splice unshift".split(" "),function(n){var t=U[n];r.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),!lr.spliceObjects&&0===n.length&&delete n[0],this
}}),_(["concat","join","slice"],function(n){var t=U[n];r.prototype[n]=function(){var n=t.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new o(n),n.__chain__=!0),n}}),typeof define=="function"&&typeof define.amd=="object"&&define.amd?(n._=r,define(function(){return r})):T&&!T.nodeType?q?(q.exports=r)._=r:T._=r:n._=r})(this);