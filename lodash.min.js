...
-b||d)},lastIndexOf:function(a,b){if(a==h)return-1;for(var c=a.length;c--;)if(a[c]===b)return c;return-1},map:$,max:pa,memoize:function(a,b){var c={};return function(){var d=b?b.apply(this,arguments):arguments[0];return r.call(c,d)?c[d]:c[d]=a.apply(this,arguments)}},min:x,mixin:ma,noConflict:function(){q._=va;return this},once:function(a){var b,c=o;return function(){if(c)return b;c=m;return b=a.apply(this,arguments)}},partial:function(a){var b=l.call(arguments,1);return b.length?function(){return arguments.length?
a.apply(this,b.concat(l.call(arguments))):a.apply(this,b)}:function(){return arguments.length?a.apply(this,arguments):a.call(this)}},pick:function(a){for(var b,c=0,d=y.apply([],arguments),e=d.length,f={};++c<e;)b=d[c],b in a&&(f[b]=a[b]);return f},pluck:L,range:function(a,b,c){c||(c=1);2>arguments.length&&(b=a||0,a=0);for(var d=-1,e=Math.max(Math.ceil((b-a)/c),0),f=Array(e);++d<e;)f[d]=a,a+=c;return f},reduce:aa,reduceRight:da,reject:B,rest:ha,result:J,shuffle:function(a){var b,c=[];v(a,function(a,
e){b=Math.floor(Math.random()*(e+1));c[e]=c[b];c[b]=a});return c},size:function(a){var b=j.call(a);return b==C||b==E?a.length:Q(a).length},some:w,sortBy:function(a,b,c){if(u(b))c&&(b=t(b,c));else var d=b,b=function(a){return a[d]};return L($(a,function(c,d){return{a:b(c,d,a),b:c}}).sort(function(a,b){var c=a.a,d=b.a;return c===h?1:d===h?-1:c<d?-1:c>d?1:0}),"b")},sortedIndex:ea,tap:function(a,b){b(a);return a},template:function(a,b,c){function d(a){return e.call(this,a,k)}c=ra(c||{},k.templateSettings);
a="__p+='"+a.replace(wa,function(a){return"\\"+z[a]}).replace(c.escape||X,function(a,b){return"'+((__t=("+P(b)+"))==null?'':_['escape'](__t))+'"}).replace(c.interpolate||X,function(a,b){return"'+((__t=("+P(b)+"))==null?'':__t)+'"}).replace(c.evaluate||X,function(a,b){return"';"+P(b)+";__p+='"})+"';\n";c.variable||(a="with(object||{}){"+a+"}");var a='var __t,__j=Array.prototype.join,__p="";function print(){__p+=__j.call(arguments,"")}'+a+"return __p",e=Function(c.variable||"object","_",a);if(b)return e(b,
k);d.source="function("+(c.variable||"object")+"){"+a+"}";return d},throttle:function(a,b){var c,d,e,f,g,j,k=ia(function(){d=g=o},b);return function(){c=arguments;f=this;j||(j=G(function(){j=h;d&&a.apply(f,c);k()},b));g?d=m:e=a.apply(f,c);k();g=m;return e}},times:function(a,b,c){c&&(b=t(b,c));for(c=0;c<a;c++)b(c)},toArray:function(a){if(!a)return[];if(u(a.toArray))return a.toArray();var b=a.length;return b===+b?l.call(a):qa(a)},union:function(){for(var a=-1,b=[],c=y.apply(b,arguments),d=c.length;++a<
d;)0>s(b,c[a])&&b.push(c[a]);return b},uniq:T,uniqueId:function(a){var b=ua++;return a?a+b:b},values:qa,without:function(a){for(var b=-1,c=a.length,d=l.call(arguments,1),e=[];++b<c;)0>s(d,a[b])&&e.push(a[b]);return e},wrap:function(a,b){return function(){var c=[a];F.apply(c,arguments);return b.apply(this,c)}},zip:function(){for(var a=-1,b=pa(L(arguments,"length")),c=Array(b);++a<b;)c[a]=L(arguments,a);return c},all:U,any:w,collect:$,detect:oa,each:v,foldl:aa,foldr:da,head:R,include:na,inject:aa,intersect:ga,
methods:I,select:S,tail:ha,take:R,unique:T});p.prototype=k.prototype;ma(k);v("pop,push,reverse,shift,sort,splice,unshift".split(","),function(a){var b=A[a];k.prototype[a]=function(){var a=this.m;b.apply(a,arguments);a.length===0&&delete a[0];return this.o?(new p(a)).chain():a}});v(["concat","join","slice"],function(a){var b=A[a];p.prototype[a]=function(){var a=b.apply(this.m,arguments);return this.o?(new p(a)).chain():a}});M(p.prototype,{chain:function(){this.o=m;return this},value:function(){return this.m}});
W?"object"==typeof module&&module&&module.p==W?(module.p=k)._=k:W._=k:(q._=k,"function"==typeof define&&"object"==typeof define.amd&&define.amd&&define(function(){return k}))})(this);
