...
describe('keys methods', function () {
  lodashStable.each(['keys', 'keysIn'], function (methodName) {
    ...
    it(
      '`_.' +
        methodName +
        '` should return the string keyed property names of `object`',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should return keys for custom properties on arrays',
      function () {
        var array = [1]
        array.a = 1
    ...
    it(
      '`_.' +
        methodName +
        '` should return keys for custom properties on `arguments` objects',
      function () {
        var values = [args, strictArgs],
          expected = lodashStable.map(
            values,
            lodashStable.constant(['0', '1', '2', 'a'])
          )
    ...
    it(
      '`_.' +
        methodName +
        '` should return keys for custom properties on string objects',
      function () {
        var object = Object('a')
        object.a = 1
    ...
    it(
      '`_.' + methodName + '` should work with array-like objects',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should coerce primitives to objects (test in IE 9)',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` skips the `constructor` property on prototype objects',
      function () {
        function Foo() {}
        Foo.prototype.a = 1
    ...
    it(
      '`_.' +
        methodName +
        '` should return an empty array when `object` is nullish',
      function () {
