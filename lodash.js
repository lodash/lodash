...
;(function() {
  ...
  function runInContext(context) {
     ...
     * @returns {Object} Returns `object`.
     */
    function baseUpdate(object, path, func) {
      return baseSet(object, path, func(baseGet(object, path)));
    }
    ...
    /**
     * Updates the value at `path` of `object` with given `func`. If a portion of `path` doesn't exist
     * it's created. Arrays are created for missing index properties while objects
     * are created for all other missing properties. The `func` is invoked with
     * `value` at `path` of `object`: (value).
     *
     * @static
     * @memberOf _
     * @category Object
     ...
     * // => 0
     */
    function update(object, path, func) {
      return object == null
        ? object
        : baseUpdate(object, path, baseCastFunction(func));
    }
