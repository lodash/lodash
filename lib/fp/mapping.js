module.exports = {
  ...
  'aryMethodMap': {
    ...
    2: (
      ...
      'intersection,invoke,invokeMap,isEqual,isMatch,lastIndexOf,map,mapKeys,mapValues,' +
      ...
      'sortedLastIndexBy,sortedUniqBy,split,startsWith,subtract,sumBy,take,takeRight,' +
