...
describe('curryRight', function () {
  ...
  it('should use `this` binding of function', function () {
    ...
    assert.deepStrictEqual(
      curryRight(bind(fn, object), 3)('c')('b')('a'),
      expected
    )
    assert.deepStrictEqual(
      curryRight(bind(fn, object), 3)('b', 'c')('a'),
      expected
    )
    assert.deepStrictEqual(
      curryRight(bind(fn, object), 3)('a', 'b', 'c'),
      expected
    )

    assert.deepStrictEqual(
      bind(curryRight(fn), object)('c')('b')('a'),
      Array(3)
    )
    assert.deepStrictEqual(
      bind(curryRight(fn), object)('b', 'c')('a'),
      Array(3)
    )
    assert.deepStrictEqual(
      bind(curryRight(fn), object)('a', 'b', 'c'),
      expected
    )
