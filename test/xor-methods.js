...
describe('xor methods', function () {
  lodashStable.each(['xor', 'xorBy', 'xorWith'], function (methodName) {
    ...
    it(
      '`_.' +
        methodName +
        '` should return the symmetric difference of two arrays',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should return the symmetric difference of multiple arrays',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should return an empty array when comparing the same array',
      function () {
        var array = [1],
    ...
    it(
      '`_.' +
        methodName +
        '` should return a new array when a single array is given',
      function () {
        var array = [1]
    ...
    it(
      '`_.' +
        methodName +
        '` should ignore values that are not arrays or `arguments` objects',
      function () {
        var array = [1, 2]
    ...
    it(
      '`_.' +
        methodName +
        '` should work when in a lazy sequence before `head` or `last`',
      function () {
