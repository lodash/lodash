module.exports = {
  ...
  'aryMethodMap': {
    ...
    2: (
      ...
      'partition,pick,pull,pullAll,pullAt,random,range,rearg,reject,remove,repeat,' +
      'result,sampleSize,set,some,sortBy,sortByOrder,sortedIndexBy,sortedLastIndexBy,' +
      'sortedUniqBy,startsWith,subtract,sumBy,take,takeRight,takeRightWhile,' +
      'takeWhile,throttle,times,truncate,union,uniqBy,without,wrap,xor,zip,' +
      'zipObject').split(','),
    3: (
