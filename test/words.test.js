...
describe('words', function () {
  ...
  it('should work with compound words', function () {
    ...
    assert.deepStrictEqual(words('enable 6h format'), [
      'enable',
      '6',
      'h',
      'format'
    ])
    assert.deepStrictEqual(words('enable 24H format'), [
      'enable',
      '24',
      'H',
      'format'
    ...
    assert.deepStrictEqual(words('tooLegit2Quit'), [
      'too',
      'Legit',
      '2',
      'Quit'
  ...
  it('should work with compound words containing diacritical marks', function () {
    assert.deepStrictEqual(words('LETTERSÆiouAreVowels'), [
      'LETTERS',
      'Æiou',
      'Are',
      'Vowels'
    ...
    assert.deepStrictEqual(words('æiou2Consonants'), [
      'æiou',
      '2',
      'Consonants'
    ])
