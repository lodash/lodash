...
var burredLetters = [
  ...
  // Latin Extended-B letters.
  '\u0180', '\u0181', '\u0182', '\u0183',                               '\u0187', '\u0188', '\u0189', '\u018A', '\u018B', '\u018C',           '\u018E',
  '\u0190', '\u0191', '\u0192', '\u0193',           '\u0195', '\u0196', '\u0197', '\u0198', '\u0199', '\u019A',           '\u019C', '\u019D', '\u019E', '\u019F',
  '\u01A0', '\u01A1', '\u01A2', '\u01A3', '\u01A4', '\u01A5', '\u01A6', '\u01A7', '\u01A8',                     '\u01AB', '\u01AC', '\u01AD', '\u01AE', '\u01AF',
  '\u01B0',           '\u01B2', '\u01B3', '\u01B4', '\u01B5', '\u01B6',                     '\u01BB',                               '\u01BF',
                      '\u01C4', '\u01C5', '\u01C6', '\u01C7', '\u01C8', '\u01C9', '\u01CA', '\u01CB', '\u01CC', '\u01CD', '\u01CE', '\u01CF', '\u01D0', '\u01D1',
  '\u01D2', '\u01D3', '\u01D4', '\u01D5', '\u01D6', '\u01D7', '\u01D8', '\u01D9', '\u01DA', '\u01DB', '\u01DC', '\u01DD', '\u01DE', '\u01DF', '\u01E0', '\u01E1',
  '\u01E2', '\u01E3', '\u01E4', '\u01E5', '\u01E6', '\u01E7', '\u01E8', '\u01E9', '\u01EA', '\u01EB', '\u01EC', '\u01ED',                     '\u01F0', '\u01F1',
  '\u01F2', '\u01F3', '\u01F4', '\u01F5', '\u01F6', '\u01F7', '\u01F8', '\u01F9', '\u01FA', '\u01FB', '\u01FC', '\u01FD', '\u01FE', '\u01FF', '\u0200', '\u0201',
  '\u0202', '\u0203', '\u0204', '\u0205', '\u0206', '\u0207', '\u0208', '\u0209', '\u020A', '\u020B', '\u020C', '\u020D', '\u020E', '\u020F', '\u0210', '\u0211',
  '\u0212', '\u0213', '\u0214', '\u0215', '\u0216', '\u0217', '\u0218', '\u0219', '\u021A', '\u021B', '\u021C', '\u021D', '\u021E', '\u021F', '\u0220', '\u0221',
  '\u0222', '\u0223', '\u0224', '\u0225', '\u0226', '\u0227', '\u0228', '\u0229', '\u022A', '\u022B', '\u022C', '\u022D', '\u022E', '\u022F', '\u0230', '\u0231',
  '\u0232', '\u0233', '\u0234', '\u0235', '\u0236', '\u0237', '\u0238', '\u0239', '\u023A', '\u023B', '\u023C', '\u023D', '\u023E', '\u023F', '\u0240', '\u0241',
  '\u0242', '\u0243', '\u0244', '\u0245', '\u0246', '\u0247', '\u0248', '\u0249', '\u024A', '\u024B', '\u024C', '\u024D', '\u024E', '\u024F',
  // Latin Extended Additional letters.
...
var deburredLetters = [
  ...
  // Converted Latin Extended-B letters.
  'b',  'B',  'B',  'b',  'C',  'c',  'D',  'D', 'D',  'd',  'E',  'E',  'F',
  'f',  'G',  'hv', 'I',  'I',  'K',  'k',  'l', 'M',  'N',  'n',  'O',  'O',
  'o',  'OI', 'oi', 'P',  'p',  'YR', 'S',  's', 't',  'T',  't',  'T',  'U',
  'u',  'V',  'Y',  'y',  'Z',  'z',  '2',  'w', 'DZ', 'Dz', 'dz', 'LJ', 'Lj',
  'lj', 'NJ', 'Nj', 'nj', 'A',  'a',  'I',  'i', 'O',  'o',  'U',  'u',  'U',
  'u',  'U',  'u',  'U',  'u',  'U',  'u',  'e', 'A',  'a',  'A',  'a',  'AE',
  'ae', 'G',  'g',  'G',  'g',  'K',  'k',  'O', 'o',  'O',  'o',  'j',  'DZ',
  'Dz', 'dz', 'G',  'g',  'HV', 'W',  'N',  'n', 'A',  'a',  'AE', 'ae', 'O',
  'o',  'A',  'a',  'A',  'a',  'E',  'e',  'E', 'e',  'I',  'i',  'I',  'i',
  'O',  'o',  'O',  'o',  'R',  'r',  'R',  'r', 'U',  'u',  'U',  'u',  'S',
  's',  'T',  't',  'Y',  'y',  'H',  'h',  'N', 'd',  'OU', 'ou', 'Z',  'z',
  'A',  'a',  'E',  'e',  'O',  'o',  'O',  'o', 'O',  'o',  'O',  'o',  'Y',
  'y',  'l',  'n',  't',  'j',  'db', 'qp', 'A', 'C',  'c',  'L',  'T',  's',
  'z',  "'",  "'",  'B',  'U',  'V',  'E',  'e', 'J',  'j',  'Q',  'q',  'R',
  'r',  'Y',  'y',
  // Converted Latin Extended Additional letters.
  'A', 'a', 'B', 'b', 'B', 'b', 'B', 'b', 'C',  'c',  'D',  'd', 'D', 'd', 'D',
  'd', 'D', 'd', 'D', 'd', 'E', 'e', 'E', 'e',  'E',  'e',  'E', 'e', 'E', 'e',
  'F', 'f', 'G', 'g', 'H', 'h', 'H', 'h', 'H',  'h',  'H',  'h', 'H', 'h', 'I',
  'i', 'I', 'i', 'K', 'k', 'K', 'k', 'K', 'k',  'L',  'l',  'L', 'l', 'L', 'l',
  'L', 'l', 'M', 'm', 'M', 'm', 'M', 'm', 'N',  'n',  'N',  'n', 'N', 'n', 'N',
  'n', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o',  'P',  'p',  'P', 'p', 'R', 'r',
  'R', 'r', 'R', 'r', 'R', 'r', 'S', 's', 'S',  's',  'S',  's', 'S', 's', 'S',
  's', 'T', 't', 'T', 't', 'T', 't', 'T', 't',  'U',  'u',  'U', 'u', 'U', 'u',
  'U', 'u', 'U', 'u', 'V', 'v', 'V', 'v', 'W',  'w',  'W',  'w', 'W', 'w', 'W',
  'w', 'W', 'w', 'X', 'x', 'X', 'x', 'Y', 'y',  'Z',  'z',  'Z', 'z', 'Z', 'z',
  'h', 't', 'w', 'y', 'a', 's', 's', 's', 'SS', 'A',  'a',  'A', 'a', 'A', 'a',
  'A', 'a', 'A', 'a', 'A', 'a', 'A', 'a', 'A',  'a',  'A',  'a', 'A', 'a', 'A',
  'a', 'A', 'a', 'E', 'e', 'E', 'e', 'E', 'e',  'E',  'e',  'E', 'e', 'E', 'e',
  'E', 'e', 'E', 'e', 'I', 'i', 'I', 'i', 'O',  'o',  'O',  'o', 'O', 'o', 'O',
  'o', 'O', 'o', 'O', 'o', 'O', 'o', 'O', 'o',  'O',  'o',  'O', 'o', 'O', 'o',
  'O', 'o', 'U', 'u', 'U', 'u', 'U', 'u', 'U',  'u',  'U',  'u', 'U', 'u', 'U',
  'u', 'Y', 'y', 'Y', 'y', 'Y', 'y', 'Y', 'y',  'LL', 'LL', 'V', 'v', 'Y', 'y'
];
