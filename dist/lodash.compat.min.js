...
};return y.after=function(n,t){if(!bt(t))throw new ae;return function(){return 1>--n?t.apply(this,arguments):void 0}},y.assign=er,y.at=function(n){var t=arguments,e=-1,r=tt(t,!0,!1,1),t=t[2]&&t[2][t[1]]===n?1:r.length,u=Xt(t);for(We.unindexedChars&&xt(n)&&(n=n.split(""));++e<t;)u[e]=n[r[e]];return u},y.bind=Jt,y.bindAll=function(n){for(var t=1<arguments.length?tt(arguments,!0,!1,1):dt(n),e=-1,r=t.length;++e<r;){var u=t[e];n[u]=ft(n[u],1,null,null,n)}return n},y.bindKey=function(n,t){return 2<arguments.length?ft(t,19,Le.call(arguments,2),null,n):ft(t,3,null,null,n)
...
return 1!=u.length||a!==a||wt(a)?function(t){for(var e=u.length,r=!1;e--&&(r=et(t[u[e]],n[u[e]],null,!0)););return r}:function(n){return n=n[o],a===n&&(0!==a||1/a==1/n)}},y.curry=function(n,t){return t=typeof t=="number"?t:+t||n.length,ft(n,4,null,null,null,t)},y.debounce=Mt,y.defaults=rr,y.defer=Ht,y.delay=function(n,t){if(!bt(n))throw new ae;var e=Le.call(arguments,2);return xe(function(){n.apply(v,e)},t)},y.difference=$t,y.filter=Ot,y.flatten=function(n,t,e,r){return typeof t!="boolean"&&null!=t&&(e=(r=e)&&r[t]===n?null:t,t=!1),null!=e&&(n=Bt(n,e,r)),tt(n,t)
