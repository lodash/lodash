...
describe('findLastIndex and lastIndexOf', function () {
  lodashStable.each(['findLastIndex', 'lastIndexOf'], function (methodName) {
    var array = [1, 2, 3, 1, 2, 3],
      ...
      resolve =
        methodName == 'findLastIndex'
          ? lodashStable.curry(lodashStable.eq)
          : identity

    it(
      '`_.' +
        methodName +
        '` should return the index of the last matched value',
      function () {
    ...
    it(
      '`_.' + methodName + '` should work with a positive `fromIndex`',
      function () {
    ...
    it(
      '`_.' + methodName + '` should work with a negative `fromIndex`',
      function () {
    ...
    it(
      '`_.' + methodName + '` should treat falsey `fromIndex` values correctly',
      function () {
    ...
    it(
      '`_.' + methodName + '` should coerce `fromIndex` to an integer',
      function () {
