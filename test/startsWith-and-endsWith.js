  ...
  lodashStable.each(['startsWith', 'endsWith'], function (methodName) {
    ...
    it(
      ...
      function () {
        ...
        assert.strictEqual(
          func({ toString: lodashStable.constant(string) }, chr),
          true
        )
      }
    )
    ...
    it(
      ...
      function () {
        ...
        assert.strictEqual(
          func(string, { toString: lodashStable.constant(chr) }),
          true
        )
      }
    )
    ...
    it(
      ...
      function () {
        ...
        assert.strictEqual(
          func(string, 'b', {
            toString: lodashStable.constant(String(position))
          }),
          true
        )
      }
    ...
    it('should return `true` when `target` is an empty string regardless of `position`', function () {
      ...
      assert.ok(
        lodashStable.every(positions, function (position) {
