...
if(null==n||null==t)return n===t;if(o=xt.call(n),u=xt.call(t),o!=u)return!1;switch(o){case ut:case it:return+n==+t;case ot:return n!=+n?t!=+t:0==n?1/n==1/t:n==+t;case ft:case lt:return n==t+""}if(u=o==et,!u){if(n instanceof i||t instanceof i)return _(n.__wrapped__||n,t.__wrapped__||t,r,e);if(o!=at)return!1;var o=n.constructor,a=t.constructor;if(o!=a&&(!d(o)||!(o instanceof o&&d(a)&&a instanceof a)))return!1}for(r||(r=[]),e||(e=[]),o=r.length;o--;)if(r[o]==n)return e[o]==t;var f=!0,l=0;if(r.push(n),e.push(t),u){if(l=t.length,f=l==n.length)for(;l--&&(f=_(n[l],t[l],r,e)););return f
}return Wt(t,function(t,u,i){return jt.call(i,u)?(l++,!(f=jt.call(n,u)&&_(n[u],t,r,e))&&Q):void 0}),f&&Wt(n,function(n,t,r){return jt.call(r,t)?!(f=-1<--l)&&Q:void 0}),f}function d(n){return typeof n=="function"}function b(n){return!(!n||!ct[typeof n])}function j(n){return typeof n=="number"||xt.call(n)==ot}function w(n){return typeof n=="string"||xt.call(n)==lt}function x(n){for(var t=-1,r=$t(n),e=r.length,u=Array(e);++t<e;)u[t]=n[r[t]];return u}function A(n,t){var r=c(),e=n?n.length:0,u=!1;return e&&typeof e=="number"?u=-1<r(n,t):Ct(n,function(n){return(u=n===t)&&Q
...
o.prototype=i.prototype;var Rt={};!function(){var n={0:1,length:1};Rt.fastBind=At&&!Dt,Rt.spliceObjects=(ht.splice.call(n,0,1),!n[0])}(1),i.templateSettings={escape:/<%-([\s\S]+?)%>/g,evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,variable:""},Ot||(f=function(n){if(b(n)){u.prototype=n;var t=new u;u.prototype=null}return t||{}}),s(arguments)||(s=function(n){return n&&typeof n=="object"?jt.call(n,"callee"):!1});var Mt=Et||function(n){return n&&typeof n=="object"?xt.call(n)==et:!1},Et=function(n){var t,r=[];
if(!n||!ct[typeof n])return r;for(t in n)jt.call(n,t)&&r.push(t);return r},$t={}.o=St?function(n){return b(n)?St(n):[]}:Et,zt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","/":"&#x2F;"},It=y(zt),Wt=function(n,t){var r;if(!n||!ct[typeof n])return n;for(r in n)if(t(n[r],r,n)===Q)break;return n},Ct=function(n,t){var r;if(!n||!ct[typeof n])return n;for(r in n)if(jt.call(n,r)&&t(n[r],r,n)===Q)break;return n};d(/x/)&&(d=function(n){return typeof n=="function"&&"[object Function]"==xt.call(n)
}),i.after=function(n,t){return function(){return 1>--n?t.apply(this,arguments):void 0}},i.bind=V,i.bindAll=function(n){for(var t=1<arguments.length?dt.apply(ht,qt.call(arguments,1)):h(n),r=-1,e=t.length;++r<e;){var u=t[r];n[u]=V(n[u],n)}return n},i.compact=function(n){for(var t=-1,r=n?n.length:0,e=[];++t<r;){var u=n[t];u&&e.push(u)}return e},i.compose=function(){var n=arguments;return function(){for(var t=arguments,r=n.length;r--;)t=[n[r].apply(this,t)];return t[0]}},i.countBy=function(n,t,r){var e={};
return t=G(t,r),F(n,function(n,r,u){r=t(n,r,u)+"",jt.call(e,r)?e[r]++:e[r]=1}),e},i.debounce=H,i.defaults=g,i.defer=function(n){var t=qt.call(arguments,1);return setTimeout(function(){n.apply(void 0,t)},1)},i.delay=function(n,t){var r=qt.call(arguments,2);return setTimeout(function(){n.apply(void 0,r)},t)},i.difference=M,i.filter=E,i.flatten=z,i.forEach=F,i.functions=h,i.groupBy=function(n,t,r){var e={};return t=G(t,r),F(n,function(n,r,u){r=t(n,r,u)+"",(jt.call(e,r)?e[r]:e[r]=[]).push(n)}),e},i.initial=function(n,t,r){if(!n)return[];
var e=0,u=n.length;if(typeof t!="number"&&null!=t){var i=u;for(t=G(t,r);i--&&t(n[i],i,n);)e++}else e=null==t||r?1:t||e;return qt.call(n,0,Bt(Nt(0,u-e),u))},i.intersection=function(n){var t=arguments,r=t.length,e=-1,u=c(),i=n?n.length:0,o=[];n:for(;++e<i;){var a=n[e];if(0>u(o,a)){for(var f=r;--f;)if(0>u(t[f],a))continue n;o.push(a)}}return o},i.invert=y,i.invoke=function(n,t){var r=qt.call(arguments,2),e=-1,u=typeof t=="function",i=n?n.length:0,o=Array(typeof i=="number"?i:0);return F(n,function(n){o[++e]=(u?t:n[t]).apply(n,r)
...
if(typeof t!="number"&&null!=t){var i=u;for(t=G(t,r);i--&&t(n[i],i,n);)e++}else if(e=t,null==e||r)return n[u-1];return qt.call(n,Nt(0,u-e))}},i.take=$,i.head=$,i.VERSION="1.3.1",K(i),i.prototype.chain=function(){return this.__chain__=!0,this},i.prototype.value=function(){return this.__wrapped__},F("pop push reverse shift sort splice unshift".split(" "),function(n){var t=ht[n];i.prototype[n]=function(){var n=this.__wrapped__;return t.apply(n,arguments),!Rt.spliceObjects&&0===n.length&&delete n[0],this
}}),F(["concat","join","slice"],function(n){var t=ht[n];i.prototype[n]=function(){var n=t.apply(this.__wrapped__,arguments);return this.__chain__&&(n=new o(n),n.__chain__=!0),n}}),typeof define=="function"&&typeof define.amd=="object"&&define.amd?(n._=i, define(function(){return i})):st&&!st.nodeType?vt?(vt.exports=i)._=i:st._=i:n._=i}(this);