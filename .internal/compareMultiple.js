...
/**
 * Used by `orderBy` to compare multiple properties of a value to another and
 * stable sort them.
 *
 * If `orders` is unspecified, all values are sorted in ascending order.
 * Otherwise, specify an order of "desc" for descending or "asc" for ascending
 * sort order of corresponding values.
 *
 * @private
