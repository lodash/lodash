...
describe('assign and assignIn', function () {
  lodashStable.each(['assign', 'assignIn'], function (methodName) {
    ...
    it(
      '`_.' + methodName + '` should assign source properties to `object`',
      function () {
    ...
    it(
      '`_.' + methodName + '` should overwrite destination properties',
      function () {
    ...
    it(
      '`_.' +
        methodName +
        '` should assign source properties with nullish values',
      function () {
    ...
    it(
      '`_.' + methodName + '` should skip assignments if values are the same',
      function () {
        var object = {}
    ...
    it(
      '`_.' + methodName + '` should treat sparse array sources as dense',
      function () {
        var array = [1]
        array[2] = 3
    ...
    it(
      '`_.' + methodName + '` should assign values of prototype objects',
      function () {
        function Foo() {}
        Foo.prototype.a = 1
    ...
    it(
      '`_.' + methodName + '` should coerce string sources to objects',
      function () {
